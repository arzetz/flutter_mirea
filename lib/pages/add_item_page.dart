...
void addCucumberToServer(Knopa knopa) async {
  final response = await http.post(
    ...
    body: jsonEncode({
      'id': knopa.id,
      'title': knopa.title,
      'description': knopa.knopaDescription,
      'price': knopa.price,
      'photo_link': knopa.photoLink,
      'likes': 0,
    }),
  );
  if (response.statusCode == 201) {
    print("Cucumber added!");
  } else {
    print("Failed to add cucumber!");
  }
}
...
class AddItemPageState extends State<AddItemPage> {
  ...
  final TextEditingController innerDescriptionController =
        ...
        child: Column(
          children: [
            ...
            TextField(
              ...
              decoration:
                  const InputDecoration(labelText: 'Подробное описание'),
            ),
            Slider(
              value: price,
              min: 500,
